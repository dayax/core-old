...
class Message
{
    static private $_cacheDir = null;

    static private $_cached = array();

    static private $_lang =  'en';
    ...
    static public function getCacheFileName($sourceFile)
    {
    ...
    static public function translateMessage()
    {
    ...
    static private function writeCache($cacheFile,$sourceFile)
    {
...
EOC;
    ...
    static private function getMessageDir($caller)
    {
    ...
    static private function getMessageFile($dir)
    {
    ...
    static private function loadCache($sourceFile)
    {
